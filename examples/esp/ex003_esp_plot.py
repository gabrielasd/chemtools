r"""
====================================================
EX3: ESP from wave-function file & user-defined cube
====================================================
...
from chemtools import  UniformGrid, Molecule, print_cx_script_isosurface
...
#    To visualize the iso-surface, use command: $ chimerax fname.cxc

print_cx_script_isosurface(fname + '.cxc', rhoname, colorfile=espname, isosurf=0.002,
