r"""
=================================
EX11: Fukui function (Finite Diff)
=================================
...
from chemtools import LocalConceptualDFT, UniformGrid, print_cx_script_isosurface
...
# 4. Generate CX scripts to plot dual-descriptor iso-surface.
#    To visualize the iso-surface, use command: $ chimerax coh2_ffp_fd.cxc

print_cx_script_isosurface('coh2_ffp_fd.cxc', 'coh2_ffp_fd.cube', isosurf=0.005)
print_cx_script_isosurface('coh2_ff0_fd.cxc', 'coh2_ff0_fd.cube', isosurf=0.005)
print_cx_script_isosurface('coh2_ffm_fd.cxc', 'coh2_ffm_fd.cube', isosurf=0.005,
                            negative=True, colorscheme=['blue', 'red'])
